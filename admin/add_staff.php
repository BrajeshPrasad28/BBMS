...
// if everything is ok, try to upload file
      ...
      if($password != $c_password){
        ...
        if (move_uploaded_file($_FILES["pimg"]["tmp_name"], $target_file)) {
            ...
            $rs=mysqli_query($con,"INSERT INTO staffinfo (name,address,state,phone,email,gender,age,dob,bloodgroup,password,pimg) VALUES ('$name','$address','$state','$phone','$email','$gender','$age','$dob','$bloodgroup','$password','$target_file')") or die(mysqli_error($con));
           	if($rs)
           	{
            ...
            <td style="vertical-align:top;padding-top:0px;">
              <p class="text-danger text-center" style="padding: 0px 0px 20px;"><?php echo $msg; ?></p>
                <table cellpadding="0" cellspacing="1px" style="width:100%; height:424px;">
                  <tr><td class="lefttd">Hospital_ID:</td><td><input type="int" id="h_id" name="h_id" value="" placeholder="Enter Hospital Id" pattern="[A-Za-z]{20, 20}" title="Please Hospital Id" required /></td></tr>
