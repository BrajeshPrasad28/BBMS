<?php
 ...
 if(isset($_POST["submit"]))
 {
  ...
  $gurdians_name=trim($_POST["gurdians_name"]);
  ...
  $any_disease=trim($_POST["any_disease"]);
...
// if everything is ok, try to upload file
      ...
      if($password != $c_password){
        ...
        if (move_uploaded_file($_FILES["pimg"]["tmp_name"], $target_file)) {
            ...
            $rs=mysqli_query($con,"INSERT INTO donarregistration (name,gurdians_name,address,state,phone,email,gender,dob,age,bloodgroup,any_disease,occupation,password,pimg) VALUES ('$name','$gurdians_name','	$address','$state','$phone','$email','$gender','$dob','$age','$bloodgroup','$any_disease','$occupation','$password','$target_file')") or die(mysqli_error($con));
           	if($rs)
           	{
 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     <nav>
       <ul>
         <P style="color: gray; float: left; margin: 6px; font-weight: bolder; font-size: 20px; font-style: italic;">WELCOME</p>
            ...
            <td style="vertical-align:top;padding-top:0px;">
              <p class="text-danger text-center" style="padding: 0px 0px 20px;"><?php echo $msg; ?></p>
                <table cellpadding="0" cellspacing="1px" style="width:100%; height:424px;">
                  ...
                  <tr><td class="lefttd">Guardians Name:</td><td><input type="text" id="guardians_name" name="gurdians_name" value="" placeholder="Enter Your Guardians Name" pattern="[A-Za-z]{20, 20}" title="Please enter your guardians name" required /></td></tr>
                 ...
                 <tr><td class="lefttd">Any Disease:</td><td><input type="text" id="any_disease" name="any_disease" value="" placeholder="Any Disease" pattern="[A-Za-z]{20, 20}" title="Any Disease" required /></td></tr>
                 <tr><td class="lefttd">Occupation:</td><td><input type="text" id="occupation" name="occupation" value="" placeholder="Enter Your Occupation"  title="Please enter your Occupation" required /></td></tr>
