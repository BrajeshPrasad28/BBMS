<?php
 ...
 $sql2 = "SELECT * from donarregistration as donordetail INNER JOIN bloodrequest as bloodreq ON donordetail.id = bloodreq.donor_id WHERE status='accepted'";
...
<?php
      ...
      while ($a = mysqli_fetch_array($query)) {
        ...
        echo "<td>".$a['status']."</td>";
        echo "<td> <form action='staff_giveblood.php' method='post' style='display: inline-block;'> <input type='hidden' name='bloodrequest_id' value='".$a['bloodrequest_id']."' > <button  type='submit' name='donate'  style='margin:0px 5px; display:inline-block;  float:left;' class='btn btn-primary'>Give Blood</button>  </form> </td>";
