<?php
 ...
 <html lang="en" dir="ltr">
   ...
   <br><br><br>
<div class="profile" style="border:2px solid brown;height: 371px;width: 637px;margin-left: 347px; ">
  <div class="col-sm-9 col-sm-offset-3" style="border: 2px solide brown; width: 491px -47px;margin-left: 0px;margin-top: -21px; position:static; margin-bottom:100px;">
    ...
    <td><img src="<?php echo $donor->pimg; ?>"  class="img" alt="Donor Image" style="border:2px solid brown;"></td>
...
<a href="update_profile.php" class="btn" style="margin-left:249px; font-family: san-sarif; border-color: brown; font-weight: bolder; background-color:orange; color:black;">Update Details</a>
</div>
